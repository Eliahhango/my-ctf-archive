...
ls -lah
sed -n "1,220p" "bugdb_v1_poc.sh"
```

If you want to execute the saved solve directly:

```bash
chmod +x "bugdb_v1_poc.sh"
./bugdb_v1_poc.sh
```
