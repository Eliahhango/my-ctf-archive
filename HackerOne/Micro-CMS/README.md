...
ls -lah
sed -n "1,220p" "micro_cms_poc.sh"
```

If you want to execute the saved solve directly:

```bash
chmod +x "micro_cms_poc.sh"
./micro_cms_poc.sh
```
